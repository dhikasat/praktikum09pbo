...
public Pekerja(String nama, String NIK,
Boolean jenisKelamin, Boolean menikah, int
jamKerja, int hariKerja, String NIP) {
...
if (getHariKerja() - (getHariKerja() /
7 * 7) == 6)
libur++;

if (getJamKerja() > 7)
bonusLembur = (getHariKerja() -
libur) * (getJamKerja() - 7) * 7;
else
bonusLembur = 0;

double bonusLibur;
if (getHariKerja() > 5)
bonusLibur = libur * getJamKerja()
* 20;
else
bonusLibur = 0;
...
return departemen + ", " + kantorCabang
+ " cabang " + getNIP().charAt(2);
}
...
(getBonus() + getGaji() + getPendapatan()) +
"$\n";
returnString += "Bonus	: " +
getBonus() + "$\n";
returnString += "Gaji	: " +
